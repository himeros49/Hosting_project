...
public static void add_customer_in_admin_panel(WebDriver driver, String name_of_the_sheet ) throws Exception {
		...
		XSSFSheet sheet = wb.getSheet(name_of_the_sheet);
			...
			try
			{
				...
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@class='kt-menu__link-text'][contains(.,'Accounts')])[1]")));

				WebElement Accounts = driver.findElement(By.xpath("(//span[@class='kt-menu__link-text'][contains(.,'Accounts')])[1]"));
				Accounts.click();					
				logger.info("Account Openend");
...
public static void add_customer_in_partner_panel(WebDriver driver, String name_of_the_sheet ) throws Exception {
