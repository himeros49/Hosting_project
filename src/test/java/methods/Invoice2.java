...
public class Invoice2 extends BaseClass{
	...
	public static void capture_invoice_details_status_paid(WebDriver driver, String name_of_the_sheet) throws Exception
	{
		...
		sheet.getRow(81).createCell(1).setCellValue(Invoice_Number);
		...
		sheet.getRow(82).createCell(1).setCellValue(Invoice_Date);
		...
		sheet.getRow(83).createCell(1).setCellValue(Invoice_Due_Date);
		...
		sheet.getRow(84).createCell(1).setCellValue(Invoice_Paid_Date);
		System.out.println(Invoice_Paid_Date);


		///Initializing Rows  
		XSSFRow row_Invoice_Goods_description_Linux = sheet.getRow(89);
		XSSFRow row_Invoice_Goods_description_addon = sheet.getRow(90);
		XSSFRow row_Invoice_Goods_description_addon2 = sheet.getRow(91);
		...
		sheet.getRow(93).createCell(11).setCellValue(Invoice_Total_Discount);
		...
		sheet.getRow(94).createCell(11).setCellValue(Invoice_SubTotal);
		...
		sheet.getRow(95).createCell(11).setCellValue(Invoice_Total_Amount);
		System.out.println(Invoice_Total_Amount);


		String automated_Invoice_Total_Discount = sheet.getRow(93).getCell(11).getStringCellValue();
		String automated_Invoice_SubTotal= sheet.getRow(94).getCell(11).getStringCellValue();
		String automated_Invoice_Total_Amount = sheet.getRow(95).getCell(11).getStringCellValue();


		String default_Invoice_Total_Discount = sheet.getRow(93).getCell(10).getStringCellValue();
		String default_Invoice_SubTotal = sheet.getRow(94).getCell(10).getStringCellValue();
		String default_Invoice_Total_Amount= sheet.getRow(95).getCell(10).getStringCellValue();
		...
		{
			sheet.getRow(93).createCell(12).setCellValue("pass");
		}
		else
		{
			sheet.getRow(93).createCell(12).setCellValue("fail");
		}


		if(automated_Invoice_SubTotal.equals(default_Invoice_SubTotal))
		{
			sheet.getRow(94).createCell(12).setCellValue("pass");
		}
		else
		{
			sheet.getRow(94).createCell(12).setCellValue("fail");
		}


		if(automated_Invoice_Total_Amount.equals(default_Invoice_Total_Amount))
		{
			sheet.getRow(95).createCell(12).setCellValue("pass");
		}
		else
		{
			sheet.getRow(95).createCell(12).setCellValue("fail");
		}
	...
	public static void capture_invoice_details_status_paid_for_partner(WebDriver driver,String name_of_the_sheet) throws Exception 
	{
		File source = new File(xlpath);
		FileInputStream fi = new FileInputStream(source);
		XSSFWorkbook wb = new XSSFWorkbook(fi);
		...
		sheet.getRow(84).createCell(1).setCellValue(Invoice_paid);
		...
		sheet.getRow(93).createCell(13).setCellValue(Invoice_SubTotal);
		System.out.println(Invoice_SubTotal);

		String Invoice_Total_Amount= driver.findElement(By.xpath("(//table[@class='invoice']//table)[7]/tbody[1]/tr[6]/td[2]")).getText();
		sheet.getRow(94).createCell(13).setCellValue(Invoice_Total_Amount);
		System.out.println(Invoice_Total_Amount);

		
		String automated_Invoice_SubTotal= sheet.getRow(93).getCell(13).getStringCellValue();
		String automated_Invoice_Total_Amount = sheet.getRow(94).getCell(13).getStringCellValue();

		String default_Invoice_SubTotal = sheet.getRow(93).getCell(12).getStringCellValue();
		String default_Invoice_Total_Amount= sheet.getRow(94).getCell(12).getStringCellValue();
		...
		if(automated_Invoice_SubTotal.equals(default_Invoice_SubTotal))
		{
			sheet.getRow(93).createCell(14).setCellValue("pass");
		}
		else
		{
			sheet.getRow(93).createCell(14).setCellValue("fail");
		}


		if(automated_Invoice_Total_Amount.equals(default_Invoice_Total_Amount))
		{
			sheet.getRow(94).createCell(14).setCellValue("pass");
		}
		else
		{
			sheet.getRow(94).createCell(14).setCellValue("fail");
		}
	...
	public static void capture_invoice_details_status_unpaid_for_partner(WebDriver driver,String name_of_the_sheet) throws Exception 
	{
		File source = new File(xlpath);
		FileInputStream fi = new FileInputStream(source);
		XSSFWorkbook wb = new XSSFWorkbook(fi);
