...
public class Choosing_hosting_custom_plan extends BaseClass{
	...
	public static WebDriver select_hosting_plan_admin_panel(WebDriver driver, String plan) throws Exception
	{
				...
				
			{
				try
				{
					...
					try {
					provisioning_setting_dropdown.selectByIndex(1);
					}
					
					catch(Exception x)
					{
						provisioning_setting_dropdown.selectByValue("payment");
					}
	...
	public static WebDriver select_hosting_plan_partner_panel(WebDriver driver, String plan) throws Exception
	{
