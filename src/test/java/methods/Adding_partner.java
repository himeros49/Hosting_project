...
public class Adding_partner extends BaseClass {
	
	static ReadConfig rd = new ReadConfig();

	
	
	public static void add_partner(WebDriver driver, String name_of_the_sheet ) throws Exception {
		...
		XSSFSheet sheet = wb.getSheet(name_of_the_sheet);
			...
			driver.findElement(By.xpath("(//span[@class='kt-menu__link-text'])[1]")).click();
			
			
			Actions ac = new Actions(driver);
			
			ac.moveToElement(driver.findElement(By.xpath("//span[text()='Partners']")));
			ac.moveToElement(driver.findElement(By.xpath("(//span[text()='Add'])[2]"))).click().perform();
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			 ...
			 email.click();
			 Thread.sleep(5000);
			 String emailid = (rd.getEmail2() + generateStringInNumber + "@gmail.com").trim();
