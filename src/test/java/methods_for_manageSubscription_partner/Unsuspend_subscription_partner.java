...
public class Unsuspend_subscription_partner {
...
//		        Thread.sleep(5000);
		        ...
		        //Perform Click on button using JavascriptExecutor		
		        js8.executeScript("arguments[0].click();", manage_sub2);
		        Thread.sleep(5000);	
		        ...
		        //Perform Click on button using JavascriptExecutor		
		        js6.executeScript("arguments[0].click();", unsuspend);
		        Thread.sleep(5000);
		        
		        WebDriverWait waitforokaybutton2 = new WebDriverWait(driver, 60);
		        waitforokaybutton2.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[text()='Ok']")));

		        //Suspend 
		        WebElement suspend_okay2 = driver.findElement(By.xpath("//button[text()='Ok']"));
		        JavascriptExecutor js7 = (JavascriptExecutor)driver;

		        //Perform Click on button using JavascriptExecutor		
		        js7.executeScript("arguments[0].click();", suspend_okay2);
		        Thread.sleep(5000);
