...
public class Create_subscription_admin {
	
	
	
	public static void create_my_subscription(WebDriver driver) throws Exception
	{
		...
		//Subscription Section present in the left panel
		        ...
		        //choose manage subscription  
		        WebElement terminate = driver.findElement(By.linkText("Terminate"));
		        JavascriptExecutor js9 = (JavascriptExecutor)driver;

		        //Perform Click on button using JavascriptExecutor		
		        js9.executeScript("arguments[0].click();", terminate);
		        Thread.sleep(5000);
...
//		        Thread.sleep(5000);
		      ...
		      //choose manage subscription  
		        ...
		        //Perform Click on button using JavascriptExecutor		
		        js7.executeScript("arguments[0].click();", create);
		        Thread.sleep(5000);

		        //create okay
		        WebElement create_okay = driver.findElement(By.xpath("//button[text()='Ok']"));
		        JavascriptExecutor js6 = (JavascriptExecutor)driver;

		        //Perform Click on button using JavascriptExecutor		
		        js6.executeScript("arguments[0].click();", create_okay);
		        Thread.sleep(5000);
		        ...
		        String successmessage = driver.findElement(By.cssSelector("div#alert-msg-flash-success>div:nth-of-type(2)")).getText();
		        String actualmesssage = "Account created successfully.";
