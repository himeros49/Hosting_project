package methods_for_manageSubcription_admin;
...
public class Unsuspend_subscription_admin {
	
	public static void unsuspend_my_subscription(WebDriver driver) throws Exception
	{
		...
		//Subscription Section present in the left panel
		        ...
		        //choose manage subscription  
		        WebElement suspend = driver.findElement(By.linkText("Suspend"));
...
//		        String actualmesssage = "Account suspended successfully.";
//		        
...
//		        Thread.sleep(5000);
		      ...
		      //choose manage subscription  
		        WebElement manage_sub2 = driver.findElement(By.cssSelector("div#headingOne6mm>div"));
		        JavascriptExecutor js10 = (JavascriptExecutor)driver;

		        //Perform Click on button using JavascriptExecutor		
		        js10.executeScript("arguments[0].click();", manage_sub2);
		        Thread.sleep(5000);	

		        
		        WebDriverWait waitforunspendbutton = new WebDriverWait(driver, 60);
		        waitforunspendbutton.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Unsuspend")));
		        
		        
		      //choose manage subscription  
		        WebElement unsuspend = driver.findElement(By.linkText("Unsuspend"));
		        JavascriptExecutor js7 = (JavascriptExecutor)driver;

		        //Perform Click on button using JavascriptExecutor		
		        js7.executeScript("arguments[0].click();", unsuspend);
		        Thread.sleep(5000);

		        //UNSuspend okay
		        WebElement unsuspend_okay = driver.findElement(By.xpath("//button[text()='Ok']"));
		        JavascriptExecutor js6 = (JavascriptExecutor)driver;

		        //Perform Click on button using JavascriptExecutor		
		        js6.executeScript("arguments[0].click();", unsuspend_okay);
		        Thread.sleep(5000);
		        ...
		        WebDriverWait waitformesssage2 = new WebDriverWait(driver, 60);
		        waitformesssage2.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div#alert-msg-flash-success>div:nth-of-type(2)")));
		        
		        
		        String successmessage = driver.findElement(By.xpath("//div[text()='Account unsuspend successfully.']")).getText();
		        System.out.println(successmessage);
		        
		        String actualmesssage = "Account unsuspend successfully.";
