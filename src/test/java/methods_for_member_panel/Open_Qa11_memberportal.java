...
public class Open_Qa11_memberportal extends BaseClass {
...
//				driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
				...
				driver.get(BaseUrl_member);
				Thread.sleep(3000);		
				
				
				//Capturing username and password
				
				String[]  cred = Login_credentials.get_login_credentials(driver, "Hosting_Memberpanel");
...
////				driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
				...
				driver.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
				driver.navigate().to(BaseUrl_member);
				Thread.sleep(3000);		
				
				
				//Capturing username and password
				
				String[]  cred_sub = Login_credentials.get_login_credentials_of_SubUser(driver, "Hosting_Memberpanel");
